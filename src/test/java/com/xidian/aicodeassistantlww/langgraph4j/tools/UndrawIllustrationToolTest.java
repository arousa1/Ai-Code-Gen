package com.xidian.aicodeassistantlww.langgraph4j.tools;

import com.xidian.aicodeassistantlww.langgraph4j.model.ImageCategoryEnum;
import com.xidian.aicodeassistantlww.langgraph4j.model.ImageResource;
...
class UndrawIllustrationToolTest {
    ...
    void testSearchIllustrations() {
        // 测试正常搜索插画
        List<ImageResource> illustrations = undrawIllustrationTool.searchIllustrations("resume");
